function data_SOO = SOEA(Task,pop,gen,selection_process,p_il,reps,directoryname,tasknumber,index,mum_,sigma_)
%SOEA function: implementation of SOEA algorithm
    ...
    for rep = 1:reps
        ...
        generation=1;
        mu = mum_;     % Index of Simulated Binary Crossover (tunable)
...
%                child(count).rnvec(swap_indicator) = temp;
    ...
    dlmwrite(filename,EvBestFitness,'precision','%.32f');    
