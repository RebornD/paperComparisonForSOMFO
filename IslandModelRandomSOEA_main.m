function  IslandModelRandomSOEA_main(every_,amount_,p_il_)
    ...
    for index = 1:9
        ...
        data_Island(index)=IslandModelRandomSOEA(Tasks,pop,gen,selection_pressure,p_il,reps,every,amount,problemname);   
    end
