function  IslandModelSOEA_main(every_,amount_,p_il_)
    ...
    every = every_; % Transfer interval is 1 generation
    amount = amount_; % Transfer volume is 5 indibiduals
    ...
    for index = 1:9
        ...
        data_Island(index)=IslandModelSOEA(Tasks,pop,gen,selection_pressure,p_il,reps,every,amount,problemname);   
    end
